...
public class MonitorAndroid extends JPanel{
	 ...
	 */
	public MonitorAndroid(){
		this.setLayout(new BorderLayout());
		
		// Set columns names
		
		String columnNames[] = { "Username", "Accept", "Decline"};
	...
	public void fillTable(){
		...
		//for (String andr : Cache.pendingAndroid) {
		//	String[] android = new String[1];
		//	android[0] = andr;
		for (Entry<String, String[]> entry : Cache.pendingAndroid.entrySet()) {
	...
	public void updateTable(){	
		...
		for (Entry<String, String[]> entry : Cache.pendingAndroid.entrySet()) {
			tableModel.addRow(entry.getValue());
		}
		    ...
		    button.addActionListener(new ActionListener() {			 
		    	public void actionPerformed(ActionEvent e)
		    	{
		    		if(rowsSelected.containsKey(table.getSelectedRow()) == false){
		    			...
		    			qdb.acceptORdeclineAndroid(true, (String) 
		    ...
		    button.addActionListener(new ActionListener() {			 
		    	public void actionPerformed(ActionEvent e)
		    	{
		    		if(rowsSelected.containsKey(table.getSelectedRow()) == false){
		    			...
		    			QueriesDB qdb = new QueriesDB();
		    			qdb.acceptORdeclineAndroid(false, (String) 
		    					table.getValueAt(table.getSelectedRow(), 0));
		    		}
		    	}
		    });
